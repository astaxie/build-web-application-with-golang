...
1. Скачайте [vscode](https://code.visualstudio.com/).  

2. Установите плагин Go. Выберите в левой панели `Расширения` или нажмите `CTRL+SHIFT+X`, затем выберите в поиске расширений `Go` от likehoban.

	![](images/1.4.vscode2.png?raw=true)
	
3. Также необходимо, чтобы уже был установлен Go, настроен GOROOT и GOPATH.  

4. Далее необходимо установить дополнительные пакеты для Go:
...
5. Теперь можно создавать проект Go.
